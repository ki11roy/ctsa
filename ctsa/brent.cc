...
/*
 * Algorithms are C translation of Richard Brent's Algol 60 procedure as
 * published in Algoritms For Minimization Without Derivatives, Richard P. Brent
 * Chapters 3-5
 */
double
brent_zero(custom_funcuni* funcuni,
    double ai,
    double bi,
    double tol,
    double eps)
...
double
brent_local_min(custom_funcuni* funcuni,
    double a,
    double b,
    double t,
    double eps,
