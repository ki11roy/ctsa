...
static void
mixed_radix_dit_rec(fft_data* op,
    fft_data* ip,
...
static void
bluestein_exp(fft_data* hl, fft_data* hlt, int len, int M)
{
...
static void
bluestein_fft(fft_data* data, fft_data* oup, fft_object obj, int sgn, int N)
{
    int K, M, ii, i;
