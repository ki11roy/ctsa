...
int grad_fd(custom_function* funcpt,
...
int grad_cd(custom_function* funcpt,
    custom_gradient* funcgrad,
    double* x,
    int N,
    double* dx,
...
int grad_calc2(custom_function* funcpt,
    double* x,
    int N,
    double* dx,
    double eps3,
...
int grad_calc(custom_function* funcpt,
    double* x,
    int N,
    double* dx,
    double eps2,
...
int cvsrch(custom_function* funcpt,
    custom_gradient* funcgrad,
    double* x,
    double* f,
    double* g,
    ...
    double xtol)
{
    ...
    double dg, dgm, dginit, dgtest, dgx, dgxm, dgy, dgym, finit, ftest1, fm, fx,
        fxm, fy, fym, p5, p66, stx, sty, stmin, stmax, width, width1, xtrapf;
   ...
   function, and derivative at the current step.
    ...
    obtained but the decrease is not sufficient.
        ...
        if (stage1 == 1 && *f <= fx && *f > ftest1) {
            ...
            infoc = cstep(
                &stx, &fx, &dgx, &sty, &fy, &dgy, stp, f, &dg, &brackt, stmin, stmax);
        }
...
int lnsrchmt(custom_function* funcpt,
    custom_gradient* funcgrad,
    double* xi,
    double* f,
    double* jac,
