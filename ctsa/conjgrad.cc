...
static int
richolu(double* A, int N, int stride, double* U22)
{
    int sc;
    int j, i, u, w;
    double u11;
...
int cgpr_mt(custom_function* funcpt,
...
int conjgrad_min_lin(custom_function* funcpt,
    custom_gradient* funcgrad,
    double* xi,
    int N,
    double* dx,
    ...
    double* xf)
{
   ...
   * exceeded. Convergence not achieved. 5.- Only First Strong Wolfe Condition
   * Achieved (Using Conjugate Gradient Method)
   *
   */
