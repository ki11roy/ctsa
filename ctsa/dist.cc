...
gamma_log(double x)
{
    /*
       ...
       * http://www.netlib.org/specfun/gamma
       *
       *      References: * [1] "Chebyshev Approximations for the Natural
    Logarithm of the Gamma Function", W. J. Cody and K. E. Hillstrom, Math.
    Comp. 21, 1967, pp. 198-203.
...
double
bfrac(double x, double a, double b, int* ctr)
{
...
double
ibeta_appx(double x, double a, double b)
{
...
double
ibetac(double x, double a, double b)
{
    double oup;
...
double
ibetad(double x, double a, double b)
{
    double oup;
    /*
...
double
betainv(double alpha, double p, double q)
{
    /*
       *   Author:
