...
double
enorm(double* x, int N)
{
    double enrm;
    int i;
    double agiant, floatn, one, rdwarf, rgiant, s1, s2, s3, xabs, x1max, x3max,
        zero;
...
void fdjac2(custom_funcmult* funcmult,
    double* x,
    int M,
    int N,
    double* fvec,
...
int lmder(custom_funcmult* funcmult,
    ...
    double* qtf)
{
    int info;
    int i, j, l, iter;
    double actred, delta, dirder, epsmch, fnorm, fnorm1, gnorm, one, par, pnorm,
        prered, p1, p5, p25, p75, p0001, ratio, sum, temp, temp1, temp2, xnorm,
        zero;
...
int lmdif(custom_funcmult* funcmult,
    double* x,
    int M,
    int N,
    double* fvec,
