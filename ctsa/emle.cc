...
alik_object
alik_init(int p, int d, int q, int N)
{
...
alik_css_seas_object
alik_css_seas_init(int p, int d, int q, int s, int P, int D, int Q, int N)
{
...
alik_seas_object
alik_seas_init(int p, int d, int q, int s, int P, int D, int Q, int N)
{
...
static void
regres(int np, int nrbar, double* rbar, double* thetab, double* beta)
{
    ...
    double* AMSE)
{
    ...
    double zero, one, two, AA, del, sumlog, ssq, sigma, A1, dt, phij, phijdt,
        phii, AMS;
    int i, j, ll, nt, nj, idk, iid, iupd, nit, iter, ind, irj;
    int ir2, ir1, id2r, id2r1, id1, idd1, idd2, i45, idrr1, iddr, jkl, jkl1,
        id2r2, ibc, l, iri1, jj;
...
double
fcss(double* b, int pq, void* params)
{
...
double
fas154(double* b, int pq, void* params)
{
...
double
fcss_seas(double* b, int pq, void* params)
{
    double value, ssq, temp;
...
double
fas154_seas(double* b, int pq, void* params)
{
    double value, ssq, sumlog, delta;
...
double
fas197(double* b, int pq, void* params)
{
