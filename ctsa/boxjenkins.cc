    ...
    double* residuals)
{
    ...
    double *inp, *b, *at, *at0, *x, *phi0, *theta0, *orig, *A, *g, *D, *h, *binc,
        *Atemp;
...
*/
    ...
    while (hmax >= e1 && it < itmax) {
        ...
        avaluem(
            orig, N, s * lps + p, s * lqs + q, phiincx + 1, thetaincx + 1, qd, atinc);
        ...
        if (suminc < sumb) {
            if (hmax < e1) {
                ...
                for (i = 0; i < k; ++i) {
                    ...
                    avaluem(
                        orig, N, s * lps + p, s * lqs + q, phix + 1, thetax + 1, qd, at0);
                    t = i * (N + qd - 1);
